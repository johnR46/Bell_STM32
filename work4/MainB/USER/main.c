...
/*-----------------------------------------------------------------------------
  variable and function for work 4 ( Create and Delete DIR)
  -------------------------------------------------------------------------------*/
int Folder_CREATE[]  = {0x00, 0x57, 0xab, 0x40};
int Folder_DELETE[]  = {0x00, 0x57, 0xab, 0x35};
...
// end variable and function for work 4
//--------------------------------------------------------------------------------------------------------
...
int main(void)
{
  ...
  delay_ms(1200);
  prepareSD_Card();
  stringToUnicodeAndSendToDisplay("welcome BELL");

  /*
    now work4 DeleteFolder ------------------------------------------
  */
